...
class _SettingsAboutTabState extends State<SettingsAboutTab> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        _buildSection(
          context,
          title: AppLocalizations.of(context)!.analyticsPrivacySection,
          children: [
            SwitchListTile(
              ...
              title: Text(
                AppLocalizations.of(context)!.anonymousAnalytics,
                style: TextStyle(fontSize: 16),
              ),
              subtitle: Text(
                AppLocalizations.of(context)!.anonymousAnalyticsSubtitle,
            ...
            ListTile(
              ...
              subtitle: Text(
                _analyticsEnabled
                    ? AppLocalizations.of(context)!.anonymousId(_deviceId ??
                        AppLocalizations.of(context)!.loadingEllipsis)
                    : AppLocalizations.of(context)!.enableAnalyticsForDeviceId,
            ...
            ListTile(
              ...
              subtitle: Text(
                AppLocalizations.of(context)!.aboutDeviceIdSubtitle,
        ...
        _buildSection(
          context,
          title: AppLocalizations.of(context)!.tabSupport,
          children: [
            _buildActionTile(
              context,
              ...
              subtitle: _hasRated
                  ? AppLocalizations.of(context)!.alreadyRatedApp
  ...
  void _showRatingDialog(BuildContext context) async {
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(AppLocalizations.of(context)!.rateExperienceQuestion),
                ...
                ConstrainedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          AppLocalizations.of(context)!.optionalFeedbackHint,
    ...
    if (result == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.thanksForFeedback),
        ),
      );
    }
