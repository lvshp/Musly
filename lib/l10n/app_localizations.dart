...
abstract class AppLocalizations {
  ...
  /// Radio station context menu option to play a station
  ///
  /// In en, this message translates to:
  /// **'Play Station'**
  ...
  /// Radio station context menu option to copy stream URL
  ///
  /// In en, this message translates to:
  /// **'Copy Stream URL'**
  ...
  /// Title for explanation of anonymous device ID
  ///
  /// In en, this message translates to:
  /// **'About Device ID'**
  String get aboutDeviceId;

  /// Explanation of anonymous device ID
  ///
  /// In en, this message translates to:
  ...
  /// Playback settings section header for lyrics options
  ///
  /// In en, this message translates to:
  /// **'Lyrics'**
  String get lyricsSettingsSection;

  /// Playback settings section header for artwork provider options
  ///
  /// In en, this message translates to:
  /// **'Artwork'**
  String get artworkSettingsSection;

  /// Toggle label for fanart.tv artwork fallback
  ///
  /// In en, this message translates to:
  /// **'Fetch artwork from fanart.tv'**
  String get fanartArtworkTitle;

  /// Subtitle for fanart.tv artwork fallback toggle
  ///
  /// In en, this message translates to:
  ...
  /// Title for fanart.tv personal API key input
  ///
  /// In en, this message translates to:
  /// **'Personal API key (BYOK)'**
  String get fanartApiKeyTitle;

  /// Subtitle for fanart.tv personal API key input
  ///
  /// In en, this message translates to:
  ...
  /// Hint text for fanart.tv API key input
  ///
  /// In en, this message translates to:
  /// **'fanart.tv API key'**
  String get fanartApiKeyHint;

  /// Status text shown after a fanart.tv API key has been saved
  ///
  /// In en, this message translates to:
  /// **'Saved. Artwork lookup will use this key when enabled.'**
  String get fanartApiKeySaved;

  /// Playback settings section and toggle title for gapless playback
  ///
  /// In en, this message translates to:
  /// **'Gapless Playback'**
  String get gaplessPlaybackTitle;
  ...
  /// Display settings section header for Now Playing themes
  ///
  /// In en, this message translates to:
  /// **'Now Playing Themes'**
  String get nowPlayingThemesSection;

  /// Display settings button title for customizing Now Playing screen
  ///
  /// In en, this message translates to:
  /// **'Customize Now Playing Screen (Beta)'**
  String get customizeNowPlayingTitle;

  /// Display settings button subtitle for customizing Now Playing themes
  ///
  /// In en, this message translates to:
  /// **'Create and manage custom themes'**
  String get customizeNowPlayingSubtitle;

  /// About settings section header for analytics and privacy
  ///
  /// In en, this message translates to:
  /// **'Analytics & Privacy'**
  String get analyticsPrivacySection;

  /// Anonymous analytics device ID label
  ///
  /// In en, this message translates to:
  /// **'Anonymous ID: {id}'**
  String anonymousId(String id);

  /// Generic loading placeholder with ellipsis
  ///
  /// In en, this message translates to:
  /// **'Loading...'**
  String get loadingEllipsis;

  /// Subtitle shown when analytics is disabled and device ID is hidden
  ///
  /// In en, this message translates to:
  /// **'Enable analytics to see your anonymous device ID'**
  String get enableAnalyticsForDeviceId;

  /// Tooltip for copying device ID
  ///
  /// In en, this message translates to:
  /// **'Copy device ID'**
  ...
  /// About settings title after user has rated the app
  ///
  /// In en, this message translates to:
  /// **'Thanks for Rating!'**
  String get thanksForRating;

  /// Rate app action title
  ///
  /// In en, this message translates to:
  /// **'Rate Musly'**
  String get rateMusly;

  /// Subtitle shown after rating app
  ///
  /// In en, this message translates to:
  /// **'You\'ve already rated the app'**
  String get alreadyRatedApp;

  /// Subtitle for rate app action
  ///
  /// In en, this message translates to:
  /// **'Share your feedback'**
  String get shareYourFeedback;

  /// Support app action title
  ///
  /// In en, this message translates to:
  /// **'Support Musly'**
  String get supportMusly;

  /// Support app action subtitle
  ///
  /// In en, this message translates to:
  ...
  /// Hint for optional rating feedback field
  ///
  /// In en, this message translates to:
  /// **'Optional feedback...'**
  ...
  /// Snackbar after submitting feedback
  ///
  /// In en, this message translates to:
  /// **'Thank you for your feedback!'**
  String get thanksForFeedback;

  /// Snackbar after adding a local music folder
  ///
  /// In en, this message translates to:
  /// **'Added folder: {path}'**
  String addedFolder(String path);

  /// Dialog title for removing a local music folder
  ///
  /// In en, this message translates to:
  /// **'Remove Folder'**
  String get removeFolder;

  /// Dialog body for removing a local music folder
  ///
  /// In en, this message translates to:
  /// **'Remove \"{path}\" from scan paths?'**
  String removeFolderQuestion(String path);

  /// Snackbar after removing a local music folder
  ///
  /// In en, this message translates to:
  /// **'Folder removed'**
  String get folderRemoved;

  /// Snackbar shown before loading full library for offline download
  ///
  /// In en, this message translates to:
  /// **'Loading library...'**
  String get loadingLibrary;

  /// Dialog body when full library cannot be loaded for offline download
  ///
  /// In en, this message translates to:
  ...
  /// Snackbar after removing one song from a playlist
  ///
  /// In en, this message translates to:
  /// **'Song removed from playlist'**
  String get songRemovedFromPlaylist;

  /// Error when removing one song from a playlist
  ///
  /// In en, this message translates to:
  /// **'Error removing song: {error}'**
  String errorRemovingSong(Object error);

  /// Error when reordering a playlist song
  ///
  /// In en, this message translates to:
  /// **'Error reordering song: {error}'**
  String errorReorderingSong(Object error);

  /// Dialog title for removing selected songs from a playlist
  ///
  /// In en, this message translates to:
  /// **'Remove songs'**
  String get removeSongsTitle;

  /// Dialog body for removing selected songs from a playlist
  ///
  /// In en, this message translates to:
  /// **'Remove {count} {count, plural, =1{song} other{songs}} from this playlist?'**
  String removeSongsQuestion(int count);

  /// Snackbar after removing selected songs from a playlist
  ///
  /// In en, this message translates to:
  /// **'{count} {count, plural, =1{song} other{songs}} removed from playlist'**
  String songsRemovedFromPlaylist(int count);

  /// Error when removing selected songs from a playlist
  ///
  /// In en, this message translates to:
  /// **'Error removing songs: {error}'**
  String errorRemovingSongs(Object error);

  /// Snackbar after downloading songs from an album or playlist
  ///
  /// In en, this message translates to:
  /// **'Downloaded {count} {count, plural, =1{song} other{songs}} from {name}'**
  String downloadedSongsFrom(int count, String name);

  /// Snackbar when starting a background song download
  ///
  /// In en, this message translates to:
  /// **'Downloading {count} {count, plural, =1{song} other{songs}} in background…'**
  String downloadingSongsInBackground(int count);

  /// Title/tooltip for playlist song reordering
  ///
  /// In en, this message translates to:
  /// **'Reorder Songs'**
  String get reorderSongs;

  /// Tooltip for ending playlist reorder mode
  ///
  /// In en, this message translates to:
  /// **'Done reordering'**
  String get doneReordering;

  /// Tooltip for selecting all songs
  ///
  /// In en, this message translates to:
  /// **'Select all'**
  String get selectAll;

  /// Tooltip for clearing selected songs
  ///
  /// In en, this message translates to:
  /// **'Deselect all'**
  String get deselectAll;

  /// Tooltip for removing selected songs
  ///
  /// In en, this message translates to:
  /// **'Remove selected'**
  String get removeSelected;

  /// Tooltip for entering song selection mode
  ///
  /// In en, this message translates to:
  /// **'Select songs'**
  String get selectSongs;

  /// Tooltip for downloading a playlist
  ///
  /// In en, this message translates to:
  /// **'Download playlist'**
  String get downloadPlaylist;

  /// Tooltip for downloading an album
  ///
  /// In en, this message translates to:
  /// **'Download album'**
  String get downloadAlbum;

  /// Dialog body for removing one song from a playlist
  ///
  /// In en, this message translates to:
  /// **'Remove \"{title}\" from this playlist?'**
  String removeSongFromPlaylistQuestion(String title);

  /// Table header for song title column
  ///
  /// In en, this message translates to:
  /// **'TITLE'**
  String get allSongsTableTitle;

  /// Table header for album column
  ///
  /// In en, this message translates to:
  /// **'ALBUM'**
  String get allSongsTableAlbum;

  /// Table header for song duration column
  ///
  /// In en, this message translates to:
  /// **'TIME'**
  String get allSongsTableTime;

  /// Empty-state subtitle on the listening history screen
  ///
  /// In en, this message translates to:
  /// **'Songs you play will appear here'**
  String get songsYouPlayAppearHere;

  /// Tooltip for shuffle-playing a song list
  ///
  /// In en, this message translates to:
  /// **'Shuffle play'**
  String get shufflePlay;

  /// Information text shown when logging into YouTube Music mode
  ///
  /// In en, this message translates to:
  ...
  /// Optional profile name field label on the login screen
  ///
  /// In en, this message translates to:
  /// **'Profile Name (optional)'**
  String get profileNameOptional;

  /// Example hint for profile name on the login screen
  ///
  /// In en, this message translates to:
  /// **'e.g. Home, Work, VPN'**
  String get profileNameExample;

  /// Tooltip for copying an error message
  ///
  /// In en, this message translates to:
  /// **'Copy error'**
  String get copyError;

  /// Snackbar after copying an error message
  ///
  /// In en, this message translates to:
  /// **'Error copied to clipboard'**
  String get errorCopiedToClipboard;

  /// Snackbar after copying a radio stream URL
  ///
  /// In en, this message translates to:
  /// **'Stream URL copied'**
  String get streamUrlCopied;

  /// Search field hint for the library search delegate
  ///
  /// In en, this message translates to:
  /// **'Search in Library...'**
  String get searchInLibrary;

  /// Empty prompt in the library search delegate
  ///
  /// In en, this message translates to:
  /// **'Search your library'**
  String get searchYourLibrary;

  /// Empty state when library playlist search has no results
  ///
  /// In en, this message translates to:
  /// **'No playlists found'**
  ...
  /// Snackbar after disabling a custom theme
  ///
  /// In en, this message translates to:
  /// **'Theme deactivated (using default)'**
  String get themeDeactivatedDefault;

  /// Snackbar after activating the default theme
  ///
  /// In en, this message translates to:
  /// **'Default theme activated'**
  String get defaultThemeActivated;

  /// Snackbar after activating a theme
  ///
  /// In en, this message translates to:
  /// **'{name} activated'**
  ...
  /// File picker title for exporting a theme
  ///
  /// In en, this message translates to:
  /// **'Export Theme'**
  ...
  /// Snackbar when exporting a theme fails
  ///
  /// In en, this message translates to:
  /// **'Export failed: {error}'**
  ...
  /// Snackbar after importing a theme successfully
  ///
  /// In en, this message translates to:
  /// **'Theme imported successfully'**
  String get themeImportedSuccessfully;

  /// Snackbar when importing a theme fails
  ///
  /// In en, this message translates to:
  /// **'Import failed: {error}'**
  String importFailed(Object error);

  /// Dialog title when importing a theme fails validation
  ///
  /// In en, this message translates to:
  /// **'Import Failed'**
  String get importFailedTitle;

  /// Dialog body before a list of theme import errors
  ///
  /// In en, this message translates to:
  /// **'The theme file contains errors:'**
  String get themeFileContainsErrors;

  /// Dialog title for custom-code theme import warning
  ///
  /// In en, this message translates to:
  /// **'Security Warning'**
  String get securityWarning;

  /// Warning shown before importing a custom-code theme
  ///
  /// In en, this message translates to:
  /// **'This theme contains custom Flutter code which may pose security risks.'**
  String get themeCustomCodeWarning;

  /// Section title for imported theme details
  ///
  /// In en, this message translates to:
  /// **'Theme Details:'**
  String get themeDetails;

  /// Section title for custom widgets in imported theme
  ///
  /// In en, this message translates to:
  /// **'Custom Widgets:'**
  String get customWidgets;

  /// Section title for dependencies in imported theme
  ///
  /// In en, this message translates to:
  /// **'Dependencies:'**
  ...
  /// Button label to import a theme with custom code enabled
  ///
  /// In en, this message translates to:
  /// **'Enable Code'**
  String get enableCode;
  ...
  /// Dialog body for deleting a theme
  ///
  /// In en, this message translates to:
  ...
  /// Snackbar after toggling safe mode
  ///
  /// In en, this message translates to:
  /// **'Safe Mode {state}'**
  ...
  /// Hint text for a new duplicated theme name
  ///
  /// In en, this message translates to:
  /// **'New theme name'**
  String get newThemeName;

  /// Button label for duplicating a theme
  ///
  /// In en, this message translates to:
  /// **'Duplicate'**
